...
fn main() {
    ...
    for path in [
        ...
        "embedder/Cargo.toml",
        "embedder/src",
        "embedder/core/Cargo.toml",
        "embedder/core/src",
        "embedder/backend/Cargo.toml",
        "embedder/backend/src",
        "embedder/winit-embedder/Cargo.toml",
        "embedder/winit-embedder/src",
        "embedder/mac-embedder/Cargo.toml",
        "embedder/mac-embedder/src",
